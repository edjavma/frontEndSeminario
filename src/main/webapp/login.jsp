...
<body ng-app="umgApp">
	...
	<script src="<c:url value='js/jquery/jquery-1.11.1.min.js' />"></script>
	...
	<script src="<c:url value='app/services/loginService.js' />"></script>
	<script src="<c:url value='app/directives/countdown.js' />"></script>
</body>
</html>